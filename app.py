...
from utils.predict import (
    ...
    TIME_POINTS, SCALE_SD, SCALE_MEAN
)
...
VAR_INFO = {
    ...
    "bl_crp":           {"label": "C-reactive Protein", "unit": "mg/L", "type": "continuous", "min": 0.01,"max": 130.0, "step": 0.1, "default": 2.0, "help": "C-reactive protein level"},
    "bl_cysc":          {"label": "Cystatin C",      "unit": "mg/L",   "type": "continuous", "min": 0.30,"max": 9.0, "step": 0.01,"default": 1.0, "help": "Serum cystatin C"},
    "CCR":             {"label": "Cre/CysC Ratio",  "unit": "",        "type": "continuous", "min": 0.20,"max": 2.5, "step": 0.01,"default": 0.79,"help": "Creatinine to cystatin C ratio"},
    "gender":           {"label": "Gender",           "unit": "",        "type": "categorical",
                         "options": {"0": "Female", "1": "Male"}, "default": "0"},
    "edu":              {"label": "Education",        "unit": "",        "type": "categorical",
                         "options": {"1": "Elementary or below", "2": "Junior high", "3": "Senior high", "4": "College or above"}, "default": "1"},
...
with col_title:
    ...
    st.markdown('<div class="sub-header">Individualized Survival Prediction Based on Cox PH Model — Validated in CHARLS Cohort</div>', unsafe_allow_html=True)
...
with left_col:
    ...
    with st.container():
        ...
        # Row 3: Cre/CysC Ratio + Gender
        r3c1, r3c2 = st.columns(2)
        with r3c1:
            CCR = st.number_input(
                f"**{VAR_INFO['CCR']['label']}** ({VAR_INFO['CCR']['unit']})",
                min_value=VAR_INFO['CCR']['min'],
                max_value=VAR_INFO['CCR']['max'],
                value=VAR_INFO['CCR']['default'],
                step=VAR_INFO['CCR']['step'],
                help=VAR_INFO['CCR']['help'],
            )
        ...
        # Row 5: Hypertension + Lung Disease
